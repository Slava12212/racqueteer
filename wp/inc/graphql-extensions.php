...
add_action( 'graphql_register_types', function () {
    ...
    $all_fields = array(
        ...
        'RqRacqueteerSubscriptionsFields'       => array( 'label', 'title', 'description', 'ctaUrl' ),
        ...
        'RqRacqueteerMembershipHeroFields'      => array( 'label', 'title', 'description', 'priceStarting', 'priceUnit', 'ctaText', 'ctaUrl', 'videoUrl' ),
        'RqRacqueteerSubscriptionsDetailFields' => array( 'label', 'title', 'description' ),
        'RqRacqueteerPriceCompareFields'        => array( 'label', 'title', 'description', 'ctaText', 'ctaUrl' ),
