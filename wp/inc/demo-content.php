...
function rq_create_programs( array &$log ): void {
    ...
    foreach ( $programs as [ $title, $color, $price, $unit, $desc, $link ] ) {
...
function rq_create_page_careers( string $nextjs, array $media, array &$log ): void {
    $content  = rq_acf_block( 'acf/racqueteer-careers-hero', [
        ...
        '_cta_text'    => 'field_chero_cta_text',
        'cta_url'      => '#open-positions',
        '_cta_url'     => 'field_chero_cta_url',
    ...
    $content .= rq_acf_block( 'acf/racqueteer-job-listings', [
        ...
        '_cta_text'    => 'field_jobs_cta_text',
        'cta_url'      => '#',
        '_cta_url'     => 'field_jobs_cta_url',
    ] );
    ...
    $content .= rq_acf_block( 'acf/racqueteer-career-contact', [
        ...
        'email'        => 'careers@racqueteer.club',
        '_email'       => 'field_cc_email',
        'email_icon'   => 'mail',
        '_email_icon'  => 'field_cc_email_icon',
        'phone'        => '+61 4 8123 4567',
        '_phone'       => 'field_cc_phone',
        'phone_icon'   => 'phone',
        '_phone_icon'  => 'field_cc_phone_icon',
