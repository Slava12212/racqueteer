...
add_action( 'acf/init', function () {
    $blocks = [
        ...
        ['name'=>'racqueteer-events','title'=>'Events Section','icon'=>'calendar-alt','keywords'=>['events'],'fields'=>[
            ...
            // what_includes repeater is registered separately in inc/events-what-includes.php
        ]],
        ...
        ['name'=>'racqueteer-about-hero','title'=>'About Hero','icon'=>'cover-image','keywords'=>['about','hero'],'fields'=>[
            ...
            ['key'=>'field_ahero_video','label'=>'Media URL','name'=>'video_url','type'=>'text','instructions'=>'Full URL to the video or image file'],
        ]],
        ['name'=>'racqueteer-mission','title'=>'Mission Section','icon'=>'heart','keywords'=>['mission'],'fields'=>[
            ...
            ['key'=>'field_miss_stat1_num','label'=>'Stat 1 Number (Blue)','name'=>'stat1_number','type'=>'text','instructions'=>'e.g. 25'],
            ['key'=>'field_miss_stat1_lbl','label'=>'Stat 1 Label (Blue)','name'=>'stat1_label','type'=>'text','instructions'=>'e.g. Courts'],
            ['key'=>'field_miss_stat2_num','label'=>'Stat 2 Number (Blue)','name'=>'stat2_number','type'=>'text','instructions'=>'e.g. 8+ — leave empty to hide divider'],
            ['key'=>'field_miss_stat2_lbl','label'=>'Stat 2 Label (Blue)','name'=>'stat2_label','type'=>'text','instructions'=>'e.g. Years of experience'],
            ['key'=>'field_miss_stat3_num','label'=>'Stat 3 Number (Red)','name'=>'stat3_number','type'=>'text','instructions'=>'e.g. 5K+'],
            ['key'=>'field_miss_stat3_lbl','label'=>'Stat 3 Label (Red)','name'=>'stat3_label','type'=>'text','instructions'=>'e.g. Members'],
            ['key'=>'field_miss_stat4_num','label'=>'Stat 4 Number (Red)','name'=>'stat4_number','type'=>'text','instructions'=>'e.g. 50+ — leave empty to hide divider'],
            ['key'=>'field_miss_stat4_lbl','label'=>'Stat 4 Label (Red)','name'=>'stat4_label','type'=>'text','instructions'=>'e.g. Events per year'],
        ]],
        ...
        ['name'=>'racqueteer-careers-hero','title'=>'Careers Hero','icon'=>'cover-image','keywords'=>['careers'],'fields'=>[
            ...
            ['key'=>'field_chero_cta_text','label'=>'CTA Text','name'=>'cta_text','type'=>'text'],
            ['key'=>'field_chero_cta_url','label'=>'CTA URL','name'=>'cta_url','type'=>'text','instructions'=>'e.g. #open-positions or https://...'],
            ['key'=>'field_chero_video','label'=>'Media URL','name'=>'video_url','type'=>'text','instructions'=>'Full URL to the video or image file'],
        ]],
        ['name'=>'racqueteer-job-listings','title'=>'Job Listings','icon'=>'list-view','keywords'=>['jobs'],'fields'=>[
            ...
            ['key'=>'field_jobs_cta_text','label'=>'Job Card Button Text','name'=>'cta_text','type'=>'text'],
            ['key'=>'field_jobs_cta_url','label'=>'Job Card Button URL','name'=>'cta_url','type'=>'text','instructions'=>'e.g. /careers, mailto:careers@racqueteer.club or https://...'],
        ]],
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [
                'key'             => 'field_loc_bg_image',
                'label'           => 'Background Image (Section)',
                'name'            => 'bg_image',
                'type'            => 'image',
                'return_format'   => 'url',
                'show_in_graphql' => false, // exposed manually via graphql-extensions.php
                'instructions'    => 'Фонове зображення для секції локацій. Задається для кожної локації окремо і змінюється при перемиканні між клубами.',
            ],
            [
                'key'               => 'field_loc_media_type',
                'label'             => 'Media Type (Right Panel)',
                'name'              => 'media_type',
                'type'              => 'select',
                ...
                'return_format'     => 'value',
                'show_in_graphql'   => false, // exposed manually via graphql-extensions.php
                'instructions'      => 'Оберіть, що показувати у правій панелі: зображення або відео.',
            ],
            [
                'key'               => 'field_loc_image',
                'label'             => 'Image',
                ...
                'type'              => 'image',
                'return_format'     => 'array',
                'instructions'      => 'Завантажте зображення для правої панелі.',
                'conditional_logic' => [ [ [ 'field' => 'field_loc_media_type', 'operator' => '==', 'value' => 'image' ] ] ],
            ],
            [
                'key'               => 'field_loc_video',
                'label'             => 'Video URL',
                'name'              => 'video',
                'type'              => 'url',
                'instructions'      => 'URL відео (.mp4) для правої панелі. Наприклад: /videos/location.mp4 або https://example.com/video.mp4',
                'conditional_logic' => [ [ [ 'field' => 'field_loc_media_type', 'operator' => '==', 'value' => 'video' ] ] ],
            ],
            [
