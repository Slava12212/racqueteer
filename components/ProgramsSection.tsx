...
function ProgramRow({
  ...
  const rowClass = `flex flex-col lg:flex-row px-5 md:px-10 lg:px-[80px] py-8 md:py-9 items-start lg:items-center gap-4 lg:gap-6 md:gap-10 border-t border-brand-border transition-colors duration-300 ${hasLink ? "cursor-pointer" : "cursor-default"} ${bgClass}`;
  const rowContent = (
    <>
      {/* Title */}
      <div
