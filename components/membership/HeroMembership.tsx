          ...
          <div className="relative w-full max-w-[545px] px-0 sm:px-0 mt-2 sm:mt-0">
            ...
            <div className="rounded-xl bg-white/[0.15] backdrop-blur-[50px] px-4 pt-6 pb-4 sm:px-6 sm:py-6 md:px-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-7">
              ...
              <button 
                ...
                type="button"
                className="btn-cta btn-cta-red flex items-center justify-center gap-3 text-white font-bold text-sm uppercase tracking-wider px-10 py-4 rounded-sm w-full sm:w-auto whitespace-nowrap transition-colors"
              >
                {content.ctaText}
