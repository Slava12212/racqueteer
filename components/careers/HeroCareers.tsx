...
import { getButtonTitle, isImageMediaUrl } from "@/lib/utils";
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-6 max-w-2xl w-full mb-8 md:mb-10">
            ...
            {ctaTitle && (
              <ScrollReveal from="bottom" delay={300}>
                <a
                  href={content.ctaUrl || "#"}
                  className="btn-cta btn-cta-red inline-flex items-center justify-center gap-3 text-white font-bold text-sm uppercase tracking-wider rounded-sm px-10 py-4 mt-2 w-full sm:w-auto transition-colors"
                >
                  {ctaTitle}
